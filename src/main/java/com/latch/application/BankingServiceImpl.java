...
public class BankingServiceImpl implements BankingService {
    ...
    public BankingServiceImpl(BankAccountService bankAccountService, CustomerService customerService, FinancialMonitoringService financialMonitoringService) {
     ...
     * must be @Transactional
     *
     * in 'REAL life' it can be better handled with a notification on a topic and multiple services listening to it
     * in order to delete the data from multiple places
     * */
    @Override
